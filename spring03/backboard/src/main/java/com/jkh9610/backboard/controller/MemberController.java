...
import com.jkh9610.backboard.service.ResetService;
import com.jkh9610.backboard.validation.MemberForm;
...
public class MemberController {
    ...
    @GetMapping("/login")
    public String login() {
        return "member/login";  // /templates/member/reset.html 만듦
    }
    ...
    public String register(MemberForm memberForm) {
        return "member/register"; // templates/member/register.html을 리턴
    }
